...
#include "hexapod_msgs/msg/detail/rpy__rosidl_typesupport_fastrtps_c.h"
...
using _RPY__ros_msg_type = hexapod_msgs__msg__RPY;
...
static uint32_t _RPY__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hexapod_msgs__msg__RPY(
...
static size_t _RPY__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hexapod_msgs__msg__RPY(
