...
#include "hexapod_msgs/msg/detail/pose__rosidl_typesupport_fastrtps_c.h"
...
#include "hexapod_msgs/msg/detail/rpy__functions.h"  // orientation
...
size_t get_serialized_size_hexapod_msgs__msg__RPY(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_hexapod_msgs__msg__RPY(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hexapod_msgs, msg, RPY)();


using _Pose__ros_msg_type = hexapod_msgs__msg__Pose;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: orientation
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, hexapod_msgs, msg, RPY
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_hexapod_msgs__msg__RPY(
...
static uint32_t _Pose__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hexapod_msgs__msg__Pose(
  ...
  size_t current_alignment)
{
  ...
  // member: orientation
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        max_serialized_size_hexapod_msgs__msg__RPY(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
static size_t _Pose__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hexapod_msgs__msg__Pose(
