...
#include "hexapod_msgs/msg/detail/pose__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const hexapod_msgs::msg::RPY &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  hexapod_msgs::msg::RPY &);
size_t get_serialized_size(
  const hexapod_msgs::msg::RPY &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const hexapod_msgs::msg::Pose & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  hexapod_msgs::msg::Pose & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  // Member: orientation
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      current_alignment +=
        hexapod_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RPY(
        inner_full_bounded, inner_is_plain, current_alignment);
      full_bounded &= inner_full_bounded;
      is_plain &= inner_is_plain;
    }
...
{
  auto typed_message =
    static_cast<const hexapod_msgs::msg::Pose *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hexapod_msgs::msg::Pose *>(
    untyped_ros_message);
...
{
  return &hexapod_msgs::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hexapod_msgs, msg, Pose)() {
  return &hexapod_msgs::msg::typesupport_fastrtps_cpp::_Pose__handle;
}
