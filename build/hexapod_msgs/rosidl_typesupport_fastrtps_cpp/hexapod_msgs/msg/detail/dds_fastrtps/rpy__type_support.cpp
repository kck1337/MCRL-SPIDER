...
#include "hexapod_msgs/msg/detail/rpy__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const hexapod_msgs::msg::RPY *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hexapod_msgs::msg::RPY *>(
    untyped_ros_message);
...
{
  return &hexapod_msgs::msg::typesupport_fastrtps_cpp::_RPY__handle;
}
